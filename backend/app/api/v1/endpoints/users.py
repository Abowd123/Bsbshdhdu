...
async def list_audit_logs(limit: int = 50, user: User = Depends(get_current_user), db: AsyncSession = Depends(get_db)):
    ...
    return [
        {
            ...
            "resource_id": l.resource_id, "ip_address": l.ip_address, "created_at": l.created_at,
        }
        for l in logs
    ]
